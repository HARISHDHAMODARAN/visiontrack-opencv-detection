...
Original file is located at
    https://colab.research.google.com/drive/1pL8LNhbaNIcVtkClKQbU0NZ_iC8aFJ5-
"""
...
im = cv2.imread("/content/images/giraffe-zebra.jpg")
objects = detect_objects(net, im)
display_objects(im, objects)

"""By using triangle similarity, which involves knowing the actual size of the object and its apparent size in the image."""